    ...
    return (
        <>
            <OverlayTrigger trigger="click" placement="bottom-end" overlay={popoverContent} rootClose>
                <div
                    className="position-relative d-inline-flex align-items-center justify-content-center me-3 user-select-none" style={{ cursor: 'pointer', width: 45, height: 40, borderRadius: "10px" }}>
                    <div className=" rounded-circle d-flex align-items-center justify-content-center ">
                        <Button
                            variant="light"
                            style={{ borderRadius: "5px", margin: "0 10px", width: 35, height: 35, display: "flex", justifyContent: "center", alignItems: "center", padding: "0", border: "1px solid #d9d9d9" }}
                        >
